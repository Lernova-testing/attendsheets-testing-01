...
import { GraduationCap, Users, TrendingUp, AlertCircle, Trash2, Search } from 'lucide-react';
      ...
      <div>
        ...
        {filteredClasses.length === 0 && searchQuery ? (
          ...
          <div className="max-h-[62vh] overflow-y-auto pr-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 p-1">
