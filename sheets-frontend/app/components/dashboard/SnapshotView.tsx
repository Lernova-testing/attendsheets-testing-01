...
import { Calendar, Users, TrendingUp, AlertCircle, Award, BarChart3, GraduationCap, Search } from 'lucide-react';
import { Class, Student, AttendanceThresholds } from '@/types';
import { calculateStudentAttendanceForRange, getStatusFromPercentage, getStudentIdentityKey } from '@/lib/statisticsHelper';
...
export const SnapshotView: React.FC<SnapshotViewProps> = ({
  ...
  const filteredClasses = searchQuery.trim()
    ...
    : classes;
  const shouldScrollClassBreakdown = filteredClasses.length > 2;
    ...
    filteredClasses.forEach(cls => {
      ...
      students.forEach(student =>
        uniqueStudentKeys.add(
          getStudentIdentityKey(student, cls.enrollment_mode)
        )
      );
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div>
        ...
        <div className={shouldScrollClassBreakdown ? 'max-h-[62vh] overflow-y-auto pr-1' : ''}>
          <div className="space-y-4 sm:space-y-6">
