...
class DatabaseManager:
    ...
    def create_class(self, user_id: str, class_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        sorting_mode = class_data.get(
            "sorting_mode",
            "file_order" if enrollment_mode == "import_data" else "ascending"
        )
    ...
    def update_class(self, user_id: str, class_id: str, class_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if ("sorting_mode" not in class_data) or (class_data.get("sorting_mode") in (None, "")):
            class_data["sorting_mode"] = current_class.get(
                "sorting_mode",
                "file_order" if enrollment_mode == "import_data" else "ascending"
            )
